                                ...
                                <div class="accordion-body">
                                    <ul class="caption-list">
                                        ...
                                        <li>
                                            ...
                                            <span class="value">{{ showAmount($withdraw->amount - $withdraw->charge) }} x {{ showAmount($withdraw->rate) }} = {{ showAmount($withdraw->final_amount) }}</span>
                                        </li>
                                        <li>
                                            <span class="caption">@lang('Status')</span>
                                            <span class="value">
                                                @php echo $withdraw->statusBadge @endphp <a href="javascript:void(0)"><i class="las la-info-circle detailBtn" data-user_data="{{ json_encode($withdraw->withdraw_information) }}" @if ($withdraw->status == 3) data-admin_feedback="{{ $withdraw->admin_feedback }}" @endif></i></a>
                                            </span>
                                        </li>
                                    </ul>
                                </div>
