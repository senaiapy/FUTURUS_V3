...
@section('content')
    <div class="{{ $layout == 'frontend' ? 'container my-120' : 'dashboard-inner' }}">
        @if ($layout == 'master')
    ...
    <x-confirmation-modal closeBtn="btn btn--dark btn--sm" submitBtn="btn btn--base btn--sm"></x-confirmation-modal>
@endsection
@push('style')
    <style>
