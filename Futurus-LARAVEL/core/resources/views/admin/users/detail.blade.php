        ...
        <div class="col-12">
            ...
            <div class="row mt-2 gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              style="6"
                              link="{{ route('admin.report.purchase.history', $user->id) }}"
                              title="Total Share"
                              icon="las la-shopping-cart"
                              value="{{ getAmount($widget['total_share']) }}"
                              bg="2"
                              type="2" />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              ...
                              value="{{ showAmount($widget['total_purchase_amount']) }}"
                              bg="secondary"
                              type="2" />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              ...
                              title="Total Profit"
                              icon="la la-coins"
                              value="{{ showAmount($user->total_profit) }}"
                              bg="13"
                              type="2" />
                </div>
