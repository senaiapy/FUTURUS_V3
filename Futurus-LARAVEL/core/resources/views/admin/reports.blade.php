                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($reports as $report)
                                    <tr>
                                        <td>{{ isset($report->req_type) ? $report->req_type : '' }}</td>
                                        <td class="text-center white-space-wrap">{{ isset($report->message) ? $report->message : '' }}</td>
                                        <td><span class="badge badge--{{ isset($report->status_class) ? $report->status_class : '' }}">{{ isset($report->status_text) ? $report->status_text : '' }}</span></td>
                                    </tr>
                                @empty
                                    <tr>
...
@push('breadcrumb-plugins')
    ...
    <a href="https://futurus-brasil.com/contact" target="_blank" class="btn btn-sm btn-outline--success"><i class="las la-headset"></i> @lang('Request for Support')</a>
@endpush
