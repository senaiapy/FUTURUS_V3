                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Dark Theme Logo')</label>
                                <x-image-uploader name="logo" :imagePath="siteLogo() . '?' . time()" :size="false" class="w-100" id="uploadLogo" :required="false" :darkMode="true" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('White Theme Logo')</label>
                                <x-image-uploader name="logo_dark" :imagePath="siteLogo('dark') . '?' . time()" :size="false" class="w-100" id="uploadLogoDark" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
