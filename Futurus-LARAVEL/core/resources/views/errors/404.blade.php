...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/templates/basic/user/css/main.css') }}">
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    <img class="w-100" src="{{ asset('assets/errors/images/error-404.png') }}" alt="image">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('home') }}" class="btn error-btn btn-outline--base mt-4">
                            <span class="icon">
