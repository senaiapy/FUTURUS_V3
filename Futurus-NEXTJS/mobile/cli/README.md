<p align="center">
    <img alt="React Native Template Pyfoundation" src="https://user-images.githubusercontent.com/11137944/93101697-808bc580-f6a2-11ea-8ce3-482be6ca456a.png" width="200" />

</p>
<h1 align="center">
  React Native Template Pyfoundation
</h1>

![expo](https://img.shields.io/github/package-json/dependency-version/pyfoundation/react-native-template-pyfoundation/expo?label=expo) ![GitHub Repo stars](https://img.shields.io/github/stars/pyfoundation/react-native-template-pyfoundation) ![GitHub commit activity (branch)](https://img.shields.io/github/commit-activity/m/pyfoundation/react-native-template-pyfoundation) ![GitHub issues](https://img.shields.io/github/issues/pyfoundation/react-native-template-pyfoundation) ![GitHub closed issues](https://img.shields.io/github/issues-closed-raw/pyfoundation/react-native-template-pyfoundation)
...
```sh
npx create-pyfoundation-app@latest MyApp

```

# Overview

As a team of experienced developers at Pyfoundation Mobile Tribe, we have spent years refining our approach to building high-quality React Native applications. Our starter kit is based on the best practices and tools that we have found to be most effective in our own projects.
...
- [Create new project ](https://starter.pyfoundation.com/docs/getting-started/create-new-app)
...
This starter is maintained by [Pyfoundation mobile tribe team](https://www.pyfoundation.com/team) and we welcome new contributors to join us in improving it. If you are interested in getting involved in the project, please don't hesitate to open an issue or submit a pull request.

In addition to maintaining this starter kit, we are also available to work on custom projects and help you build your dream app. If you are looking for experienced and reliable developers to bring your app vision to life, please visit our website at [pyfoundation.com/contact](https://www.pyfoundation.com/contact) to get in touch with us. We would be happy to discuss your project in more detail and explore how we can help you achieve your goals.
...
If you have any questions about the starter and want answers, please check out the [Discussions](https://github.com/pyfoundation/react-native-template-pyfoundation/discussions) page.
