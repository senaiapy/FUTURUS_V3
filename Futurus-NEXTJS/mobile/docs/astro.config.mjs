...
const site = 'https://starter.pyfoundation.com/';

// https://astro.build/config
export default defineConfig({
  site: 'https://starter.pyfoundation.com/',
  integrations: [
    starlight({
      title: 'Pyfoundation Starter | React Native Template',
      ...
      social: {
        github: 'https://github.com/pyfoundation/react-native-template-pyfoundation',
      },
      head: [
        {
          tag: 'meta',
