...
description: Let's create a new React native project with pyfoundation starter.
head:
  - tag: title
    content: Create a new App | React Native / Expo Starter
---

Let's create a new React Native project with Pyfoundation starter.
...
Start your project using `create-pyfoundation-app` command:
