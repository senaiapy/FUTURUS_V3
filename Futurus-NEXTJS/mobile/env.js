 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.pyfoundation.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.futurus'; // ios bundle id
const PACKAGE = 'com.futurus'; // android package name
const NAME = 'FUTURUS'; // app name
const EXPO_ACCOUNT_OWNER = 'pyfoundation'; // expo account owner
const EAS_PROJECT_ID = '8764f640-68b7-477f-a1cc-e20b79b14e1f'; // Will be filled by eas project:init
const SCHEME = 'futurus'; // app scheme
