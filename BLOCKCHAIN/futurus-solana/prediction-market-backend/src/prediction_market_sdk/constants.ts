...
export const PREDICTION_ID = new PublicKey(
  process.env.PREDICTION_ID || "6tb9fNKNxfEfzAPda2NScrq9RpxBJqPWQWiqWtnQm3oY"
);
...
// ─── Oracle ─────────────────────────────────────────────────────────────
export const FUT_USDC_FEED = process.env.FUT_USDC_FEED || "GvDMxPzN1sCj7L26YDK2HnMRXEQmQ2aemov8YBtPS7vR";
...
export const feeAuthority = new PublicKey(
  process.env.FEE_AUTHORITY || "99ULgGDkjraTZxy7ccX6f2gq6axcF7u2tMqsz3s45Uw1"
);

// ─── Default Token Amounts ──────────────────────────────────────────────
export const tokenAAmount = Number(process.env.TOKEN_A_AMOUNT || 10000000);
export const tokenBAmount = Number(process.env.TOKEN_B_AMOUNT || 10000000);
